...
# Examples:
    ...
    Employee.create(first_name:  "Jhon", last_name: "Snow", date_of_birth: "08/25/2000", driver_license: "JS100278", salary_per_hour: 45.00, ssn: 144123456, cell_phone: "3235615786", email: "jhon.snow@example.com", street: "7045 hollywood Ave", second_address: "apt 204", city: "Los Angeles", state: "CA", zipcode: 90025, nationality: "England", start_date: DateTime.now.strftime('%G/%m/%d'), phone_number: "3341578", status: "active", employable_type: "Worker", employable_id: 1)
